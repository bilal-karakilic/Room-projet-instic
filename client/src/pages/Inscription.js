    ...
    const handleSubmit = async (e) => {
        ...
        if(name && password && password2 && email ) {
            if(password == password2) {
                console.log('passer');
                try {
                    const resp = await axios.post('http://localhost:3080/api/v1/sign/add',{
                ...
                setError('Les mot de passes ne correspond pas');
            }
        } else {
            ...
            <div className="container-form">
                ...
                <form onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <div>
                        ...
                        <input type='password' placeholder="Confirmer votre mot de passe" value={password2} onChange={(e) => setPassword2(e.target.value)} />
                    </div>
